...
if("TRUE" STREQUAL "TRUE")
  set(common_SOURCE_PREFIX /home/saxijing/cilqr/src/common)
  set(common_DEVEL_PREFIX /home/saxijing/cilqr/devel)
  set(common_INSTALL_PREFIX "")
  set(common_PREFIX ${common_DEVEL_PREFIX})
else()
  set(common_SOURCE_PREFIX "")
  set(common_DEVEL_PREFIX "")
  set(common_INSTALL_PREFIX /home/saxijing/cilqr/install)
...
if(NOT "/home/saxijing/cilqr/src/common/include " STREQUAL " ")
  set(common_INCLUDE_DIRS "")
  set(_include_dirs "/home/saxijing/cilqr/src/common/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saxijing/cilqr/src/common/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/saxijing/cilqr/devel/lib;/home/saxijing/tf2/catkin_ws/devel/lib;/home/saxijing/carla-ros-bridge/catkin_ws/devel/lib;/home/saxijing/cv_bridge/catkin_ws/install/lib;/opt/ros/melodic/lib)
