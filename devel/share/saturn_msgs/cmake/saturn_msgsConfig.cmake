...
if(NOT "/home/saxijing/cilqr/devel/include " STREQUAL " ")
  set(saturn_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/saxijing/cilqr/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'saturn_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saxijing/cilqr/src/message/saturn_msgs/${idir}'.  ${_report}")
    endif()
