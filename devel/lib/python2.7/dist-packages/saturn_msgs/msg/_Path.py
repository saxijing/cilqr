...
"""autogenerated by genpy from saturn_msgs/Path.msg. Do not edit."""
import codecs
import sys
...
class Path(genpy.Message):
  _md5sum = "5329b3c8e4d0d10f7d64d970ba2d2048"
  _type = "saturn_msgs/Path"
...
"""
  ...
  _slot_types = ['std_msgs/Header','saturn_msgs/StateLite[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = saturn_msgs.msg.StateLite()
        _v3 = val1.header
        start = end
        end += 4
