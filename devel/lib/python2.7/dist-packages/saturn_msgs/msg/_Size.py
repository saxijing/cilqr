...
"""autogenerated by genpy from saturn_msgs/Size.msg. Do not edit."""
import codecs
import sys
...
class Size(genpy.Message):
  _md5sum = "0122303aa1e5e98fff82adf25a489b8a"
  _type = "saturn_msgs/Size"
...
string frame_id
"""
  __slots__ = ['header','length','width','height','wheel_base','wheel_track']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,length,width,height,wheel_base,wheel_track
